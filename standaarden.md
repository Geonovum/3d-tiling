...
<link rel=File-List href="standaarden_bestanden/filelist.xml">
<!--[if gte mso 9]><xml>
...
<link rel=themeData href="standaarden_bestanden/themedata.thmx">
<link rel=colorSchemeMapping href="standaarden_bestanden/colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
  <w:View>Print</w:View>
  <w:Zoom>140</w:Zoom>
...
.MsoChpDefault
 ...
 /* Page Definitions */
 @page
	{mso-footnote-separator:url("standaarden_bestanden/header.htm") fs;
	mso-footnote-continuation-separator:url("standaarden_bestanden/header.htm") fcs;
	mso-endnote-separator:url("standaarden_bestanden/header.htm") es;
	mso-endnote-continuation-separator:url("standaarden_bestanden/header.htm") ecs;}
@page WordSection1
...
<p class=MsoNormal>I3S is geoptimaliseerd voor het werken met gegevens in de
